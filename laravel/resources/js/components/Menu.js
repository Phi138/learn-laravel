export default class Menu {
  ...
  bindEventFocusOnMenu() {
    ...
    console.log('this.$firstLinkInMenu.get(0)', this.$firstLinkInMenu)
    console.log(' this.$lastLinkInMenu.get(0)', this.$lastLinkInMenu.get(0))
  ...
  clickLiOpenDropdownMenuLeve1() {
    this.li.on('click', (e) => this.microOpenCloseLevel1(e, this.isopenchild, true))
  }
